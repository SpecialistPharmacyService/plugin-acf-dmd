...
if (!class_exists('acf_field_vtm')):
    ...
    class acf_field_vtm extends acf_dmd_field
{
        /*
         *  __construct
         *
        ...
        public function input_admin_enqueue_scripts()
    {
            ...
            // register & include JS
            wp_register_script('acf-input-vtm', "{$url}assets/js/input-vtm.js", array('acf-input'), $version);
            wp_enqueue_script('acf-input-vtm');

            // register & include CSS
            wp_register_style('acf-input-vtm', "{$url}assets/css/input-vtm.css", array('acf-input'), $version);
