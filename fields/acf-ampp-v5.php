...
if (!class_exists('acf_field_ampp')):
    ...
    class acf_field_ampp extends acf_dmd_field
{
    ...
    {
            $this->name     = 'ampp';
            $this->label    = __('Actual Medicinal Product Pack (AMPP)', 'acf-ampp');
            ...
            add_action('wp_ajax_acf/fields/ampp/query', array($this, 'ajax_query'));
            add_action('wp_ajax_nopriv_acf/fields/ampp/query', array($this, 'ajax_query'));
         ...
         *  @return    $results array of ampp
         */
        public function find_ampps($name)
    {
            return $this->find_by_types(['AMPP'], $name);
        }
        ...
        public function render_field_settings($field)
    {
            ...
            acf_render_field_setting($field, array(
                'label'        => __('Font Size', 'acf-ampp'),
                'instructions' => __('Customise the input font size', 'acf-ampp'),
                'type'         => 'number',
                'name'         => 'font_size',
                'prepend'      => 'px',
            ));
        ...
        public function input_admin_enqueue_scripts()
    {
            ...
            // register & include JS
            wp_register_script('acf-input-ampp', "{$url}assets/js/input-ampp.js", array('acf-input'), $version);
            wp_enqueue_script('acf-input-ampp');

            // register & include CSS
            wp_register_style('acf-input-ampp', "{$url}assets/css/input-ampp.css", array('acf-input'), $version);
